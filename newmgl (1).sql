...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='后台菜单表' AUTO_INCREMENT=239 ;
...
(121, 0, 0, 1, 30, 'portal', 'AdminIndex', 'default', '', '公共管理', 'th', '公共门户管理'),
...
(163, 0, 0, 1, 10000, 'portal', 'AdminIndex', 'wedding', '', '婚礼管理', 'ravelry', ''),
(164, 163, 1, 1, 10000, 'portal', 'AdminWeddingArticle', 'index', 'division_id=1', '文章管理', '', '婚礼文章列表'),
(165, 164, 1, 0, 10000, 'portal', 'AdminWeddingArticle', 'add', 'division_id=1', '添加文章', '', ''),
(166, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'addPost', 'division_id=1', '添加文章提交', '', ''),
(167, 164, 1, 0, 10000, 'portal', 'AdminWeddingArticle', 'edit', 'division_id=1', '编辑文章', '', ''),
(168, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'editPost', 'division_id=1', '编辑文章提交', '', ''),
(169, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'delete', 'division_id=1', '文章删除', '', ''),
(170, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'publish', 'division_id=1', '文章发布', '', ''),
(171, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'top', 'division_id=1', '文章置顶', '', ''),
(172, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'recommend', 'division_id=1', '文章推荐', '', ''),
(173, 164, 2, 0, 10000, 'portal', 'AdminWeddingArticle', 'listOrder', 'division_id=1', '文章排序', '', ''),
(174, 163, 1, 1, 10000, 'portal', 'AdminWeddingCategory', 'index', 'division_id=1', '分类管理', '', ''),
(175, 174, 1, 0, 10000, 'portal', 'AdminWeddingCategory', 'add', 'division_id=1', '添加文章分类', '', ''),
(176, 174, 2, 0, 10000, 'portal', 'AdminWeddingCategory', 'addPost', 'division_id=1', '添加文章分类提交', '', ''),
(177, 174, 1, 0, 10000, 'portal', 'AdminWeddingCategory', 'edit', 'division_id=1', '编辑文章分类', '', ''),
(178, 174, 2, 0, 10000, 'portal', 'AdminWeddingCategory', 'editPost', 'division_id=1', '编辑文章分类提交', '', ''),
(179, 174, 1, 0, 10000, 'portal', 'AdminWeddingCategory', 'select', 'division_id=1', '文章分类选择对话框', '', ''),
(180, 174, 2, 0, 10000, 'portal', 'AdminWeddingCategory', 'listOrder', 'division_id=1', '文章分类排序', '', ''),
(181, 174, 2, 0, 10000, 'portal', 'AdminWeddingCategory', 'delete', 'division_id=1', '删除文章分类', '', ''),
(182, 163, 1, 1, 10000, 'portal', 'AdminWeddingPage', 'index', 'division_id=1', '页面管理', '', ''),
(183, 182, 1, 0, 10000, 'portal', 'AdminWeddingPage', 'add', 'division_id=1', '添加页面', '', ''),
(184, 182, 2, 0, 10000, 'portal', 'AdminWeddingPage', 'addPost', 'division_id=1', '添加页面提交', '', ''),
(185, 182, 1, 0, 10000, 'portal', 'AdminWeddingPage', 'edit', 'division_id=1', '编辑页面', '', ''),
(186, 182, 2, 0, 10000, 'portal', 'AdminWeddingPage', 'editPost', 'division_id=1', '编辑页面提交', '', ''),
(187, 182, 2, 0, 10000, 'portal', 'AdminWeddingPage', 'delete', 'division_id=1', '删除页面', '', ''),
(188, 0, 1, 1, 10000, 'portal', 'AdminIndex', 'baby', '', '宝宝宴管理', 'child', ''),
(189, 188, 1, 1, 10000, 'portal', 'AdminBabyArticle', 'index', 'division_id=2', '文章管理', '', ''),
(190, 189, 1, 0, 10000, 'portal', 'AdminBabyArticle', 'add', 'division_id=2', '添加文章', '', ''),
(191, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'addPost', 'division_id=2', '添加文章提交', '', ''),
(192, 189, 1, 0, 10000, 'portal', 'AdminBabyArticle', 'edit', 'division_id=2', '编辑文章', '', ''),
(193, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'editPost', 'division_id=2', '编辑文章提交', '', ''),
(194, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'delete', 'division_id=2', '文章删除', '', ''),
(195, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'publish', 'division_id=2', '文章发布', '', ''),
(196, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'top', 'division_id=2', '文章置顶', '', ''),
(197, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'listOrder', 'division_id=2', '文章排序', '', ''),
(198, 188, 1, 1, 10000, 'portal', 'AdminBabyCategory', 'index', 'division_id=2', '分类管理', '', ''),
(199, 198, 1, 0, 10000, 'portal', 'AdminBabyCategory', 'add', 'division_id=2', '添加文章分类', '', ''),
(200, 198, 2, 0, 10000, 'portal', 'AdminBabyCategory', 'addPost', 'division_id=2', '添加文章分类提交', '', ''),
(201, 198, 1, 0, 10000, 'portal', 'AdminBabyCategory', 'edit', 'division_id=2', '编辑文章分类', '', ''),
(202, 198, 2, 0, 10000, 'portal', 'AdminBabyCategory', 'editPost', 'division_id=2', '编辑文章分类提交', '', ''),
(203, 198, 1, 0, 10000, 'portal', 'AdminBabyCategory', 'select', 'division_id=2', '文章分类选择对话框', '', ''),
(204, 198, 2, 0, 10000, 'portal', 'AdminBabyCategory', 'listOrder', 'division_id=2', '文章分类排序', '', ''),
(205, 198, 2, 0, 10000, 'portal', 'AdminBabyCategory', 'delete', 'division_id=2', '删除文章分类', '', ''),
(206, 188, 1, 1, 10000, 'portal', 'AdminBabyPage', 'index', 'division_id=2', '页面管理', '', ''),
(207, 206, 1, 0, 10000, 'portal', 'AdminBabyPage', 'add', 'division_id=2', '添加页面', '', ''),
(208, 206, 2, 0, 10000, 'portal', 'AdminBabyPage', 'addPost', 'division_id=2', '添加页面提交', '', ''),
(209, 206, 1, 0, 10000, 'portal', 'AdminBabyPage', 'edit', 'division_id=2', '编辑页面', '', ''),
(210, 206, 2, 0, 10000, 'portal', 'AdminBabyPage', 'editPost', 'division_id=2', '编辑页面提交', '', ''),
(211, 206, 2, 0, 10000, 'portal', 'AdminBabyPage', 'delete', 'division_id=2', '删除页面', '', ''),
(212, 0, 1, 1, 10000, 'portal', 'AdminIndex', 'party', '', '聚荟管理', 'beer', ''),
(213, 212, 1, 1, 10000, 'portal', 'AdminPartyArticle', 'index', 'division_id=3', '文章管理', '', ''),
(214, 213, 1, 0, 10000, 'portal', 'AdminPartyArticle', 'add', 'division_id=3', '添加文章', '', ''),
(215, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'addPost', 'division_id=3', '添加文章提交', '', ''),
(216, 213, 1, 0, 10000, 'portal', 'AdminPartyArticle', 'edit', 'division_id=3', '编辑文章', '', ''),
(217, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'editPost', 'division_id=3', '编辑文章提交', '', ''),
(218, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'delete', 'division_id=3', '文章删除', '', ''),
(219, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'publish', 'division_id=3', '文章发布', '', ''),
(220, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'top', 'division_id=3', '文章置顶', '', ''),
(221, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'recommend', 'division_id=3', '文章推荐', '', ''),
(222, 189, 2, 0, 10000, 'portal', 'AdminBabyArticle', 'recommend', 'division_id=3', '文章推荐', '', ''),
(223, 213, 2, 0, 10000, 'portal', 'AdminPartyArticle', 'listOrder', 'division_id=3', '文章排序', '', ''),
(224, 212, 1, 1, 10000, 'portal', 'AdminPartyCategory', 'index', 'division_id=3', '分类管理', '', ''),
(225, 224, 1, 0, 10000, 'portal', 'AdminPartyCategory', 'add', 'division_id=3', '添加文章分类', '', ''),
(226, 224, 2, 0, 10000, 'portal', 'AdminPartyCategory', 'addPost', 'division_id=3', '添加文章分类提交', '', ''),
(227, 224, 1, 0, 10000, 'portal', 'AdminPartyCategory', 'edit', 'division_id=3', '编辑文章分类', '', ''),
(228, 224, 2, 0, 10000, 'portal', 'AdminPartyCategory', 'editPost', 'division_id=3', '编辑文章分类提交', '', ''),
(229, 224, 1, 0, 10000, 'portal', 'AdminPartyCategory', 'select', 'division_id=3', '文章分类选择对话框', '', ''),
(230, 224, 2, 0, 10000, 'portal', 'AdminPartyCategory', 'listOrder', 'division_id=3', '文章分类排序', '', ''),
(231, 224, 2, 0, 10000, 'portal', 'AdminPartyCategory', 'delete', 'division_id=3', '删除文章分类', '', ''),
(232, 212, 1, 1, 10000, 'portal', 'AdminPartyPage', 'index', 'division_id=3', '页面管理', '', ''),
(233, 232, 1, 0, 10000, 'portal', 'AdminPartyPage', 'add', 'division_id=3', '添加页面', '', ''),
(234, 232, 2, 0, 10000, 'portal', 'AdminPartyPage', 'addPost', 'division_id=3', '添加页面提交', '', ''),
(235, 232, 1, 0, 10000, 'portal', 'AdminPartyPage', 'edit', 'division_id=3', '编辑页面', '', ''),
(236, 232, 2, 0, 10000, 'portal', 'AdminPartyPage', 'editPost', 'division_id=3', '编辑页面提交', '', ''),
(237, 232, 2, 0, 10000, 'portal', 'AdminPartyPage', 'delete', 'division_id=3', '删除页面', '', ''),
(238, 6, 1, 1, 10000, 'admin', 'city', 'index', '', '城市管理', '', '');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='权限规则表' AUTO_INCREMENT=239 ;
...
(138, 1, 'portal', 'admin_url', 'portal/AdminIndex/default', '', '公共管理', ''),
...
(163, 1, 'portal', 'admin_url', 'portal/AdminIndex/wedding', '', '婚礼管理', ''),
(164, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/index', 'divisionId=1', '文章管理', ''),
(165, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/add', '', '添加文章', ''),
(166, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/addPost', 'divisionId=1', '添加文章提交', ''),
(167, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/edit', 'divisionId=1', '编辑文章', ''),
(168, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/editPost', 'divisionId=1', '编辑文章提交', ''),
(169, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/delete', 'divisionId=1', '文章删除', ''),
(170, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/publish', 'divisionId=1', '文章发布', ''),
(171, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/top', 'divisionId=1', '文章置顶', ''),
(172, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/recommend', 'divisionId=1', '文章推荐', ''),
(173, 1, 'portal', 'admin_url', 'portal/AdminWeddingArticle/listOrder', 'divisionId=1', '文章排序', ''),
(174, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/index', 'divisionId=1', '分类管理', ''),
(175, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/add', 'divisionId=1', '添加文章分类', ''),
(176, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/addPost', '', '添加文章分类提交', ''),
(177, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/edit', '', '编辑文章分类', ''),
(178, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/editPost', '', '编辑文章分类提交', ''),
(179, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/select', '', '文章分类选择对话框', ''),
(180, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/listOrder', '', '文章分类排序', ''),
(181, 1, 'portal', 'admin_url', 'portal/AdminWeddingCategory/delete', '', '删除文章分类', ''),
(182, 1, 'portal', 'admin_url', 'portal/AdminWeddingPage/index', '', '页面管理', ''),
(183, 1, 'portal', 'admin_url', 'portal/AdminWeddingPage/add', '', '添加页面', ''),
(184, 1, 'portal', 'admin_url', 'portal/AdminWeddingPage/addPost', '', '添加页面提交', ''),
(185, 1, 'portal', 'admin_url', 'portal/AdminWeddingPage/edit', '', '编辑页面', ''),
(186, 1, 'portal', 'admin_url', 'portal/AdminWeddingPage/editPost', '', '编辑页面提交', ''),
(187, 1, 'portal', 'admin_url', 'portal/AdminWeddingPage/delete', '', '删除页面', ''),
(188, 1, 'portal', 'admin_url', 'portal/AdminIndex/baby', '', '宝宝宴管理', ''),
(189, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/index', '', '文章管理', ''),
(190, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/add', '', '添加文章', ''),
(191, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/addPost', '', '添加文章提交', ''),
(192, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/edit', '', '编辑文章', ''),
(193, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/editPost', '', '编辑文章提交', ''),
(194, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/delete', '', '文章删除', ''),
(195, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/publish', '', '文章发布', ''),
(196, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/top', '', '文章置顶', ''),
(197, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/listOrder', '', '文章排序', ''),
(198, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/index', '', '分类管理', ''),
(199, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/add', '', '添加文章分类', ''),
(200, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/addPost', '', '添加文章分类提交', ''),
(201, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/edit', '', '编辑文章分类', ''),
(202, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/editPost', '', '编辑文章分类提交', ''),
(203, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/select', '', '文章分类选择对话框', ''),
(204, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/listOrder', '', '文章分类排序', ''),
(205, 1, 'portal', 'admin_url', 'portal/AdminBabyCategory/delete', '', '删除文章分类', ''),
(206, 1, 'portal', 'admin_url', 'portal/AdminBabyPage/index', '', '页面管理', ''),
(207, 1, 'portal', 'admin_url', 'portal/AdminBabyPage/add', '', '添加页面', ''),
(208, 1, 'portal', 'admin_url', 'portal/AdminBabyPage/addPost', '', '添加页面提交', ''),
(209, 1, 'portal', 'admin_url', 'portal/AdminBabyPage/edit', '', '编辑页面', ''),
(210, 1, 'portal', 'admin_url', 'portal/AdminBabyPage/editPost', '', '编辑页面提交', ''),
(211, 1, 'portal', 'admin_url', 'portal/AdminBabyPage/delete', '', '删除页面', ''),
(212, 1, 'portal', 'admin_url', 'portal/AdminIndex/party', '', '聚荟管理', ''),
(213, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/index', '', '文章管理', ''),
(214, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/add', 'divisionId=1', '添加文章', ''),
(215, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/addPost', '', '添加文章提交', ''),
(216, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/edit', '', '编辑文章', ''),
(217, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/editPost', '', '编辑文章提交', ''),
(218, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/delete', '', '文章删除', ''),
(219, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/publish', '', '文章发布', ''),
(220, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/top', '', '文章置顶', ''),
(221, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/recommend', '', '文章推荐', ''),
(222, 1, 'portal', 'admin_url', 'portal/AdminBabyArticle/recommend', '', '文章推荐', ''),
(223, 1, 'portal', 'admin_url', 'portal/AdminPartyArticle/listOrder', '', '文章排序', ''),
(224, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/index', '', '分类管理', ''),
(225, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/add', '', '添加文章分类', ''),
(226, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/addPost', '', '添加文章分类提交', ''),
(227, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/edit', '', '编辑文章分类', ''),
(228, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/editPost', '', '编辑文章分类提交', ''),
(229, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/select', '', '文章分类选择对话框', ''),
(230, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/listOrder', '', '文章分类排序', ''),
(231, 1, 'portal', 'admin_url', 'portal/AdminPartyCategory/delete', '', '删除文章分类', ''),
(232, 1, 'portal', 'admin_url', 'portal/AdminPartyPage/index', '', '页面管理', ''),
(233, 1, 'portal', 'admin_url', 'portal/AdminPartyPage/add', '', '添加页面', ''),
(234, 1, 'portal', 'admin_url', 'portal/AdminPartyPage/addPost', '', '添加页面提交', ''),
(235, 1, 'portal', 'admin_url', 'portal/AdminPartyPage/edit', '', '编辑页面', ''),
(236, 1, 'portal', 'admin_url', 'portal/AdminPartyPage/editPost', '', '编辑页面提交', ''),
(237, 1, 'portal', 'admin_url', 'portal/AdminPartyPage/delete', '', '删除页面', ''),
(238, 1, 'admin', 'admin_url', 'admin/city/index', '', '城市管理', '');
...
CREATE TABLE IF NOT EXISTS `cmf_city` (
  ...
  `wedding_phone` varchar(12) DEFAULT NULL COMMENT '婚礼手机号',
  `baby_phone` varchar(12) DEFAULT NULL COMMENT '宝宝手机号',
  `party_phone` varchar(12) DEFAULT NULL COMMENT '聚荟手机号',
  `list_order` float NOT NULL DEFAULT '10000' COMMENT '排序',
...
INSERT INTO `cmf_city` (`id`, `city_name`, `wedding_phone`, `baby_phone`, `party_phone`, `list_order`, `create_time`) VALUES
(1, '北京·太阳公元', '13693267266', '15098800312', '13156414754', 10000, '2018-11-18 05:45:39'),
(2, '上海·外滩', '13693267266', NULL, NULL, 10000, '2018-11-18 05:45:57'),
(3, '天津·爱琴海', '13693267266', NULL, NULL, 10000, '2018-11-18 05:46:07'),
(4, '南京·1865', '13693267266', NULL, NULL, 10000, '2018-11-18 05:46:13'),
(5, '南京·外秦淮', '13693267266', NULL, NULL, 10000, '2018-11-18 05:46:20');
...
CREATE TABLE IF NOT EXISTS `cmf_hook` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='系统钩子表' AUTO_INCREMENT=72 ;
...
CREATE TABLE IF NOT EXISTS `cmf_hook_plugin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='系统钩子插件表' AUTO_INCREMENT=3 ;
...
(1, 10000, 1, 'admin_login', 'RexseaAdminLogin'),
(2, 10000, 1, 'switch_theme', 'TcSwitchTheme');
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 ROW_FORMAT=COMPACT COMMENT='全站配置表' AUTO_INCREMENT=6 ;
...
(1, 1, 'site_info', '{"site_name":"XZEC","site_seo_title":"ThinkCMF\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6","site_seo_keywords":"ThinkCMF,php,\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6,cmf,cms,\\u7b80\\u7ea6\\u98ce, simplewind,framework","site_seo_description":"ThinkCMF\\u662f\\u7b80\\u7ea6\\u98ce\\u7f51\\u7edc\\u79d1\\u6280\\u53d1\\u5e03\\u7684\\u4e00\\u6b3e\\u7528\\u4e8e\\u5feb\\u901f\\u5f00\\u53d1\\u7684\\u5185\\u5bb9\\u7ba1\\u7406\\u6846\\u67b6","site_icp":"","site_gwa":"","site_admin_email":"","site_analytics":""}'),
...
(5, 1, 'admin_dashboard_widgets', '[{"name":"CmfHub","is_system":1},{"name":"CmfDocuments","is_system":1},{"name":"MainContributors","is_system":1},{"name":"Contributors","is_system":1},{"name":"Custom1","is_system":1},{"name":"Custom2","is_system":1},{"name":"Custom3","is_system":1},{"name":"Custom4","is_system":1},{"name":"Custom5","is_system":1}]');
...
CREATE TABLE IF NOT EXISTS `cmf_plugin` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='插件表' AUTO_INCREMENT=3 ;
...
(1, 1, 0, 1, 0, 'RexseaAdminLogin', '黑客帝国背景登录页面', '', '', 'Jason', '', '1.0', '纯JS黑客背景登录页面~~', '[]'),
(2, 1, 0, 1, 0, 'TcSwitchTheme', '手机端模板控制', '', '', 'Jason', '', '1.0', '手机端模板控制', '{"wapthems":""}');
...
CREATE TABLE IF NOT EXISTS `cmf_portal_category` (
  ...
  `city_id` int(12) DEFAULT NULL COMMENT '城市id',
  `division_id` int(11) DEFAULT NULL COMMENT '区分婚礼宝宝聚荟',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='portal应用 文章分类表' AUTO_INCREMENT=8 ;

--
-- 转存表中的数据 `cmf_portal_category`
--

INSERT INTO `cmf_portal_category` (`id`, `parent_id`, `post_count`, `status`, `delete_time`, `list_order`, `name`, `description`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `more`, `city_id`, `division_id`) VALUES
(1, 0, 0, 1, 0, 1, '测试', '', '0-1', '', '', '', 'list', 'article', '{"thumbnail":""}', 1, 1),
(2, 0, 0, 1, 0, 10000, '上海', '', '0-2', '', '', '', 'list', 'article', '{"thumbnail":""}', 2, NULL),
(3, 0, 0, 1, 0, 10000, '文章管理', '', '0-3', '', '', '', 'list', 'article', '{"thumbnail":""}', 2, NULL),
(4, 0, 0, 1, 0, 2, '文章管理', '', '0-4', '', '', '', 'list', 'article', '{"thumbnail":""}', 2, 1),
(5, 0, 0, 1, 0, 3, '上海', '', '0-5', '', '', '', 'list', 'article', '{"thumbnail":""}', 1, 1),
(6, 0, 0, 1, 0, 4, '文章管理', '', '0-6', '', '', '', 'list', 'article', '{"thumbnail":""}', 1, 1),
(7, 0, 0, 1, 0, 5, '文章管理', '', '0-7', '', '', '', 'list', 'article', '{"thumbnail":""}', 1, 1);
...
CREATE TABLE IF NOT EXISTS `cmf_route` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='url路由表' AUTO_INCREMENT=13 ;
...
(1, 5000, 1, 2, 'portal/List/index?id=1', 'test	'),
(2, 4999, 1, 2, 'portal/Article/index?cid=1', 'test	/:id'),
(3, 5000, 1, 2, 'portal/List/index?id=2', 'test2'),
(4, 4999, 1, 2, 'portal/Article/index?cid=2', 'test2/:id'),
(5, 5000, 1, 2, 'portal/List/index?id=3', 'test3'),
(6, 4999, 1, 2, 'portal/Article/index?cid=3', 'test3/:id'),
(7, 5000, 1, 2, 'portal/List/index?id=4', 'test3'),
(8, 4999, 1, 2, 'portal/Article/index?cid=4', 'test3/:id'),
(9, 5000, 1, 2, 'portal/List/index?id=6', 'test3123'),
(10, 4999, 1, 2, 'portal/Article/index?cid=6', 'test3123/:id'),
(11, 5000, 1, 2, 'portal/List/index?id=7', 'test31111'),
(12, 4999, 1, 2, 'portal/Article/index?cid=7', 'test31111/:id');
...
(1, 1, 0, 0, 1542501368, 0, 0, '0.00', 1542435518, 1, 'admin', '###1ad45d929d67433333cc124b85301e8f', 'admin', '164466159@qq.com', '', '', '', '127.0.0.1', '', '', NULL);
...
(1, 1, 1557987527, 1542435527, 'fed8c522dcf3db26d57ee589b9993c972545bc85ae863b117951d041514635af', 'web');
